    ...
    return (
        <div className="px-8 py-4 lg:py-8">
            <div className="max-w-7xl mx-auto">
                <p className="text-base text-justify">Quanty is a fast, friendly data analyzer that explains your results, not just the final numbers. Paste a list of values and get clear steps, formulas, and interpretations for the most common statistics.</p>
                ...
                <p className="text-base mt-8 text-justify">Whether you're a student, researcher, or professional, Quanty makes statistics more accessible by combining accuracy, clarity, and learning in one tool.</p>
            </div>
        </div>
    )
}